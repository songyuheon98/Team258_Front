...
class AdminUsersServiceTest {
    ...
    class BasicReadTest {
        ...
        void Admin_getAllUsersSuccess() {
            ...
            // when
            List<AdminUsersResponseDto> result = adminUsersService.getAllUsers();
    ...
    class BasicDeleteTest {
        ...
        //
        //    // when
        //    MessageDto result = adminUsersService.deleteUser(1L, user);
        //
        //    // then
        ...
        void deleteNonExistingUserFail() {
            ...
            assertThrows(IllegalArgumentException.class,
                    () -> adminUsersService.deleteUser(1L, any(User.class)),
                    "회원을 찾을 수 없습니다.");
        }
    }
    ...
    class LoginnedDeleteTest {
        ...
        //
        //    // when
        //    MessageDto msg = adminUsersService.deleteUser(3L, userToDelete);
        //
        //    // then
        ...
        void deleteNonExistingUserFail() {
            ...
            // when & then
            assertThrows(IllegalArgumentException.class,
                    () -> adminUsersService.deleteUser(3L, any(User.class)),
                    "회원을 찾을 수 없습니다.");
        }
    }
}
